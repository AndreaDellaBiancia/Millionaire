...
import { setIsAnswerSelected, setIsNewGame, setIsStartTimer } from "../store/gameReducer";
import { setPointsGame } from "../store/awardsReducer";
import { setIsAskPublic, setIsHalfPossibility } from "../store/helpReducer";

export function endGame(navigate: any, dispatch: any, isNewGame: boolean, isStartTimer: boolean) {
